 ...
 */
final class Version20200831142848 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE antecedant_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE antecedant (id INT NOT NULL, patient_id INT NOT NULL, label VARCHAR(255) NOT NULL, commentaire TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_366F16A06B899279 ON antecedant (patient_id)');
        ...
        $this->addSql('ALTER TABLE antecedant ADD CONSTRAINT FK_366F16A06B899279 FOREIGN KEY (patient_id) REFERENCES patient (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE antecedant DROP CONSTRAINT FK_366F16A06B899279');
        ...
        $this->addSql('DROP SEQUENCE antecedant_id_seq CASCADE');
